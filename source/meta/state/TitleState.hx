...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl = new FlxSprite(85, 0);
		logoBl.frames = Paths.getSparrowAtlas('menus/base/title/pulse_logo');
		logoBl.antialiasing = true;
		logoBl.animation.addByPrefix('pulse', 'pulse', 24);
		...
		subtitle = new FlxSprite(365, FlxG.height * 0.75);
		subtitle.frames = Paths.getSparrowAtlas('menus/base/title/subtitle');
		subtitle.animation.addByPrefix('pulse', "subtitle", 24);
	...
	override function beatHit()
	{
		...
		{
			case 5:
				createCoolText(['keno', 'hypersam', 'zipcorner']);
