...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		**/
		...
		var fireplace_1 = new FlxSprite(-120, -30);
		fireplace_1.frames = Paths.getSparrowAtlas('menus/base/mainmenu/fire_freeplay');
		fireplace_1.antialiasing = true;
		fireplace_1.setGraphicSize(Std.int(fireplace_1.width * 0.75));
		fireplace_1.animation.addByPrefix('flaming', 'fireplace', 24, true);
		fireplace_1.animation.play('flaming');
		fireplace_1.updateHitbox();
		add(fireplace_1);
		
		var fireplace_2 = new FlxSprite(-120, -30).loadGraphic(Paths.image('menus/base/mainmenu/fire_empty'));
		fireplace_2.antialiasing = true;
		fireplace_2.setGraphicSize(Std.int(fireplace_2.width * 0.75));
		fireplace_2.updateHitbox();
		//add(fireplace_2);
